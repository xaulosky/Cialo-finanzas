...
const Layout = () => {
    ...
    const menuItems = [
        ...
        { divider: true, label: 'RRHH' },
        { path: '/departamentos', icon: '🏢', label: 'Departamentos' },
        { path: '/cargos', icon: '💼', label: 'Cargos' },
        { path: '/trabajadores', icon: '👷', label: 'Trabajadores' },
        { path: '/liquidaciones', icon: '💵', label: 'Liquidaciones' },
        { path: '/conceptos-nomina', icon: '📑', label: 'Conceptos Nómina' },
        { path: '/vacaciones', icon: '🏖️', label: 'Vacaciones' },
        { path: '/licencias', icon: '🏥', label: 'Licencias' },
        { divider: true, label: 'Gestión' },
        { path: '/centros-costo', icon: '📊', label: 'Centros de Costo' },
